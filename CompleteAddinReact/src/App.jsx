...
import Layout from './components/Layout'; // This handles both web and mobile layout views
...
function App() {
  return (
    <>
      <Routes>
        {/* Shared layout that decides mobile vs desktop styling */}
        <Route path="/" element={<Layout />}>
          ...
          <Route path="vehicle-loan">
            ...
            <Route path="*" element={<MobileNotFound />} /> {/* 404 for mobile */}
          </Route>
